...
public class LicenseController {
    ...
    public ResponseEntity<License> getLicense(@PathVariable Integer organizationId,
    ...
    public ResponseEntity<String> updateLicense(@PathVariable Integer organizationId,
